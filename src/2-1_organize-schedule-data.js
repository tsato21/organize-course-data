...
function organizedClassScheduleDataType1() {
  ...
  let programDataSheetName = Browser.inputBox(`Input the name of the sheet where you pasted the class schedule data provided by the Program (e.g., 2-1_Schedule Data by Program).`,Browser.Buttons.OK_CANCEL);
  ...
  let displaySheetName = Browser.inputBox(`Input the name of the sheet where organized course offering data is displayed (e.g., 2-1_Organized Schedule Data).`,Browser.Buttons.OK_CANCEL);
